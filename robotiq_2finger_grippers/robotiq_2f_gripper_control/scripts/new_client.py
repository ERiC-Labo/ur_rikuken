...
def operate_gripper():
    ...
    robotiq_client = actionlib.SimpleActionClient("/robotiq_controller/follow_joint_trajectory", FollowJointTrajectoryAction)
    ...
    # goal.trajectory.points[1].positions = [1]
    # goal.trajectory.points[1].time_from_start = rospy.Time(2)
